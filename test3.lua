...
RunService.Heartbeat:Connect(function()
    ...
    -- Movimiento anti-predict
    local mult = 2
    if not isFlying then
        -- Aumentar intensidad si estás en movimiento
        ...
        -- Solo afecta velocidad interna, no se nota visualmente
        hrp.AssemblyLinearVelocity = hrp.AssemblyLinearVelocity + offset
    else
        -- Movimiento para aviones
        local plane = char
